...
class CellPhone:
    ...
    #the set_manufact method accepts an argument
    #for the phone's manufacturer

    def set_manufact(self, manufact):
        sefl.__manufact = manufact

    #the set_model method accepts an argument
